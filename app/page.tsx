        ...
        <div className="flex-1 overflow-y-auto bg-background-light dark:bg-background-dark p-6">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <button
                    ...
                    className="w-full py-4 border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-xl text-slate-500 dark:text-slate-400 hover:border-primary hover:text-primary dark:hover:border-primary-dark dark:hover:text-primary-dark transition-colors flex items-center justify-center gap-2 group cursor-pointer"
                >
                    <span className="material-icons-round group-hover:scale-110 transition-transform">
                        add_circle_outline
                    </span>
