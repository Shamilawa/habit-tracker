    ...
    return (
        <aside className="hidden md:flex flex-col w-64 border-r border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark transition-colors duration-300 z-20">
            ...
            <nav className="flex-1 overflow-y-auto py-6 px-3 space-y-1">
                ...
                <Link
                    href="#"
                    className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700/50 hover:text-slate-900 dark:hover:text-slate-100 transition-colors group"
                >
                    <span className="material-icons-round text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300">
                        dashboard
                    </span>
                    Dashboard
                </Link>
                <Link
                    href="#"
                    className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary-dark ring-1 ring-inset ring-primary/20"
                >
            ...
            <div className="p-4 border-t border-border-light dark:border-border-dark bg-slate-50 dark:bg-slate-900/50">
                ...
                >
                    <img /* Using img for remote url without configuring remote patterns yet for Next.js Image */
                        alt="User Avatar"
